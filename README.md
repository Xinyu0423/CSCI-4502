...
## Note for This Class
1. I took this class at the undergraduate level, so I didn't write some parts of the homework (some parts were written specifically for graduate students)
2. This is an overall an easy class, but you can learn a lot from this class if you interested in data.
