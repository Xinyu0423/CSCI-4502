...
def checktags(currentevent,currenttag):
    ...
    synonymoustag2=["Meet","School","Homework","Due","Exam","CSCI","Final","Library","Campus","Class","Enrollment","Midterm","Graduate","Quiz","Finals","Lab","Ceremony"]
    synonymoustag3=["Dinner","Lunch","Breakfast","Coffe","Visit","FEST","Show"]
    synonymoustag4=["Flight","Arrive"]
    synonymoustag5=["Party","Movie"]
